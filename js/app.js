...
function updateStats() {
  ...
  document.getElementById("incorrect").textContent = totalWrong;
}
...
function getRandomCharacter() {
  ...
  const keys = Object.keys(characters[currentMode]);
...
function checkAnswer() {
  ...
  const correctAnswer = characters[currentMode][currentChar];
  totalAttempts++;
  ...
  updateStats();
  setTimeout(getRandomCharacter, 1500);
}

document.getElementById("mode").addEventListener("change", getRandomCharacter);
